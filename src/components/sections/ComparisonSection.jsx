    ...
    <section className="bg-background section-pad">
      <div className="container-rias">
        ...
        <div ref={tableRef} className="reveal max-w-4xl mx-auto">
          <div className="rounded-[20px] overflow-hidden shadow-elevated border border-border">
            <div className="grid grid-cols-1 md:grid-cols-2">
              {/* Tanpa Komunitas */}
              <div className="h-full bg-surface-dark p-6 md:p-8 flex flex-col">
              ...
              {/* Rias Karsa */}
              <div className="relative h-full bg-primary border-t md:border-t-0 md:border-l-2 border-primary-ink/15 p-6 md:p-8 flex flex-col">
